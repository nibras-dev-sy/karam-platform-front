...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-lg mx-auto p-8 bg-white rounded-lg shadow mt-10">
      <h1 className="text-2xl font-bold text-[#213448] mb-6">Edit Profile</h1>
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label className="block text-sm font-medium text-[#213448] mb-2" htmlFor="email">Email</label>
          <input
            id="email"
            type="email"
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-[#213448] mb-2" htmlFor="password">New Password</label>
          <input
            id="password"
            type="password"
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#547792] focus:border-[#547792]"
